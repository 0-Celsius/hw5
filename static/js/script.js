...
function refillRack() {
  ...
  while (rack.length < 7 && tileData.length > 0) {
    ...
    const $tile = $("<div>")
      .addClass("tile")
      .css("background-image", `url('static/images/Scrabble_Tiles/Scrabble_Tile_${tile.letter}.jpg')`)
...
function generateBoard() {
  ...
  for (let i = 0; i < 15; i++) {
    ...
    if (i === 2 || i === 12) {
      ...
      $slot.css("background-image", "url('static/images/Scrabble_Tiles/Scrabble_Tile_Blank.jpg')");
